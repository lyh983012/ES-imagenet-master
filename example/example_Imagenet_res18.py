...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7  nohup python -m torch.distributed.launch --nproc_per_node=8 example_Imagenet_res18.py
...
names = 'Res18_dvsimagenet_testLYH'
save_folder = 'imagenet_exp_18_new'
