...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python -m torch.distributed.launch --nproc_per_node=7 compare_ES_3DCNN34.py
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 nohup python -m torch.distributed.launch --nproc_per_node=7 compare_ES_3DCNN34.py
...
master = False 
names = 'ESimagenet_exp_3DCNN34'
save_folder = 'ESimagenet_exp_3DCNN34'
