...
- The converted **event-frame** version (40GB, events are organized as 8 event-frames instead of lists) can be found in [Tsinghua Cloud2](https://cloud.tsinghua.edu.cn/d/ee07f304fb3a498d9f0f/)
